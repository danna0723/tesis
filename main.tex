...
% usar con XETEX
% \usepackage[no-math]{fontspec}\usepackage{longtable}
\usepackage{array}
\usepackage{tabularx}
...
% \setmainfont{Times New Roman}\setlength{\parskip}{1em} % sangria de 1.2cm en la primera linea del parrafo
...
\clearpage %or \cleardoublepage             %───────────────────────────────────────────
\phantomsection                             %  seccion sin numeracion y listado en la 
\addcontentsline{toc}{section}{GLOSARIO}    %  tabla de contenido 
\section*{GLOSARIO}                         % (https://en.wikibooks.org/wiki/LaTeX/Document_Structure#Section_numbering)  
                                            %───────────────────────────────────────────
...
\input{sections/diseño_desarrollo.tex}

\section{RESULTADOS}
\input{sections/resultados.tex}

\section{ANALISIS DE RESULTADOS Y JUICIO DE INGENIERIA}
\input{sections/analisis_resultados.tex.tex}
