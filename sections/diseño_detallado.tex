...
\input{sections/etapa1_carga.tex}

\paragraph{Etapa 2: Segmentación de productos}
\input{sections/etapa2_segmentacion.tex}

\paragraph{Etapa 3: Construcción de variables}
\input{sections/etapa3_construccion_variables.tex}

\paragraph{Etapa 4: Modelos de predicción}
\input{sections/etapa4_modelos_prediccion.tex}
...
\input{sections/modelo_datos.tex}

\paragraph{Diseño UX/UI}
\input{sections/diseño_ux_ui.tex}