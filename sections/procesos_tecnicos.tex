...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{lXl}
        ...
        Usuario & Persona registrada en el sistema, con un rol (administrador o personal de inventario), asociada a una empresa mediante clave foránea. & 1 : N \\
        Pedido & Proveedor, cantidad, costo y usuario responsable de un pedido confirmado, asociado a una empresa. & 1 : N \\
        Corrida & Registro de un procesamiento de archivo, con sus parámetros y métricas globales; tabla padre de los resultados detallados del pipeline. & 1 : N \\
        Resultados de la corrida & Conjunto de tablas hijas de Corrida: segmentación, métricas por modelo, predicciones de backtest, pronóstico futuro, reposición y validación cruzada. & N : 1 (respecto a Corrida) \\
        Actividad & Bitácora de acciones realizadas por los usuarios (subir archivo, confirmar/deshacer pedido, crear usuario), asociada a una empresa. & 1 : N \\
        \bottomrule
    \end{tabularx}
\end{table}
